...
if __name__ == "__main__":
    ...
    model_bounds = model.ModelBounds((5,5), (3,3), 1, 10)
    ...
    kl_agent = agent.LearnersAgent((5,5), 3, 3, 1/20, kl_ucrl, model_bounds, rng)
    ...
    for i in range(1000000000):
        if i % 1000 == 0 and i != 0:
            ...
            print(f"(kl) trailing gain: {rc_observer.trailing_gain(1000)}")
        sim.step()
        rc_sim.step()
