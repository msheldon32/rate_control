...
if __name__ == "__main__":
    ...
    model_bounds = model.ModelBounds((50,0), (2,1), 1, 5, 5, 3)
    ...
    optimal_agent = agent.PolicyAgent((50,0), 2,1, policy, rng)
    rc_agent = agent.RC_Agent((50,0),2,1, model_bounds, rng)
    abl_agent = agent.RC_Agent((50,0),2,1, model_bounds, rng, True)
