...
if __name__ == "__main__":
    ...
    model_bounds = model.ModelBounds((20,20), (3,3), 1, 10)
    ...
    optimal_agent = agent.PolicyAgent((20,20), 3,3, policy, rng)
    rc_agent = agent.RC_Agent((20, 20),3,3, model_bounds, rng)
    kl_ucrl = KL_UCRL(model_bounds.n_states, model_bounds.n_actions, 0.020)
    kl_agent = agent.LearnersAgent((20,20), 3, 3, 1/20, kl_ucrl, model_bounds, rng)
